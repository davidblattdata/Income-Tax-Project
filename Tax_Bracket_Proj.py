...
###Returns Federal and State tax for 2023 income

#Continues until you exit the program
while True:
        
    #Amount Given
    amount = input('Press x to exit or type a salary: ')
    if amount.lower() == 'x':
        break
    amount = float(amount)
    ...
    print("\nThe difference between married and single is: $" + str(round(difference)))
